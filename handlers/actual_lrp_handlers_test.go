...
var _ = Describe("ActualLRP Handlers", func() {
	...
	Describe("ActualLRPGroups", func() {
		...
		Context("when the DB has no actual_lrps table", func() {
			BeforeEach(func() {
				fakeActualLRPDB.ActualLRPGroupsReturns([]*models.ActualLRPGroup{}, models.ErrNoTable)
			})
	...
	Describe("ActualLRPGroupsByProcessGuid", func() {
		...
		Context("when the DB has no actual_lrps table", func() {
			BeforeEach(func() {
				fakeActualLRPDB.ActualLRPGroupsByProcessGuidReturns([]*models.ActualLRPGroup{}, models.ErrNoTable)
			})
